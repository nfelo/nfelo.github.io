...
public-domain World Cup JSON as a second, independently validated source. Conflicting
duplicate scores stop publication. This project is independent and is not affiliated
